...
class AppColors {
  ...
  static const Color kPrimary = Color(0xFFd20511);

  /// Accent brand color - Bright red
  static const Color kAccent = Color(0xFFD40511);

  /// Secondary brand color - Dim Red
  static const Color kSecondary = Color(0x88f49096);

  /// Accent brand color - Dim red
  static const Color kSecondaryAccent = Color(0x88D40511);

  /// Secondary brand color - Dim white
  static const Color kTertiary = Colors.white;

  /// Accent brand color - Dim whte
  static const Color kTertiaryAccent = Colors.white;
  ...
  static const Color light = Color(0xAAEFEFEF);
  static const Color onLight = Colors.black;

  static const Color dark = Color(0xAA3D3D3D);
  static const Color onDark = Colors.white;
  static const Color darkTransparent = Color(0x663D3D3D);
  ...
  static const Color secondaryAction = Color(0xFFB6AE9F);
  static const Color onSecondaryAction = Colors.black;

  static const Color windowsGrey = Color(0xFFEFECE3);
  static const Color onWindowsGrey = Colors.black;

  static const Color lightSuccess = Color(0xFFC8E6C9); // Colors.green.shade100
  static const Color lightError = Color(0xFFFFCDD2); // Colors.red.shade100
  static Color get lightWarning => Colors.orange.shade100;

  static const Color lightInfo = Color(0xFFBBDEFB); // Colors.blue.shade100
}
...
extension CustomColors on ColorScheme {
  ...
  Color get borderLight => Color(0x80888888); // Colors.grey.withAlpha(128)
