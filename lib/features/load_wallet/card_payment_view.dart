...
class CardPaymentVeiew extends StatefulWidget {
  const CardPaymentVeiew({super.key});

  @override
  State<CardPaymentVeiew> createState() => _CardPaymentVeiewState();
}

class _CardPaymentVeiewState extends State<CardPaymentVeiew> {
