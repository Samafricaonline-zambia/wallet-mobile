...
import 'package:sampay_wallet/features/international_payments/widgets/bank_form.dart';
import 'package:watch_it/watch_it.dart';

class InternationalBankPaymentsPage extends StatelessWidget with WatchItMixin {
  final InternationalPaymentsService paymentsService =
      getIt<InternationalPaymentsService>();
  InternationalBankPaymentsPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return OptionsLayout(
      title: "Bank Payment",
      child: BankPaymentForm(onSubmit: handleOnSubmit),
    );
  }
}
