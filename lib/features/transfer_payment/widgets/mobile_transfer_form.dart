...
class MobileTransferForm extends StatelessWidget with WatchItMixin {
  ...
  MobileTransferForm({super.key, this.onSubmit, required this.option});
  ...
  Widget build(BuildContext context) {
    ...
    final int selectedServiceIndex = watchValue(
                      ...
                      onSubmit?.call(
                        transferRequest.copyWith(
                          service: AppConstants
                              .AIRTIME_MERCHANTS[selectedServiceIndex],
                        ),
                      );
                    }
                  }
    ...
    return Container(
      ...
      child: SimpleForm(
        ...
        children: [
          SimpleDropDown(
            items: AppConstants.AIRTIME_MERCHANTS,
            labelText: "Service Provider",
            icon: AppIcons.merchant,
            initialValue: AppConstants.AIRTIME_MERCHANTS[selectedServiceIndex],
            onIndexChanged: transferService.updateSelectedServiceIndex,
          ),
          EmptySpace.small(),
          SimpleTextField(
